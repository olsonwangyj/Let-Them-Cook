...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031* PrivateKeyInfo_GetBytes_m7D3AFC62DC76180A827AC8B1D549BB181165B71A (PrivateKeyInfo_t28A9EE4065B3A3A02D373C6FC28EE45E394D9354* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_26);
		RuntimeObject* L_27;
		L_27 = VirtualFuncInvoker0< RuntimeObject* >::Invoke(35, L_26);
		V_3 = L_27;
	}
	{
...
IL_000a:
	{
		...
		NullCheck(L_1);
		VirtualActionInvoker1< int64_t >::Invoke(12, L_1, L_2);
...
IL_00a4:
	{
		...
		NullCheck(L_25);
		int64_t L_26;
		L_26 = VirtualFuncInvoker0< int64_t >::Invoke(10, L_25);
...
IL_000f:
	...
	}
	{
		...
		NullCheck(L_4);
		VirtualActionInvoker1< int64_t >::Invoke(12, L_4, L_6);
...
IL_000f:
	{
		...
		NullCheck(L_1);
		VirtualActionInvoker1< int64_t >::Invoke(12, L_1, L_3);
		V_1 = 0;
